...
func (f formfileFetcher) Fetch(ctx echo.Context, t Token) (*multipart.FileHeader, gerr.Error) {
	if ctx.Request() == nil {
...
func (f formFetcher) Fetch(ctx echo.Context, t Token) (string, gerr.Error) {
