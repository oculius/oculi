...
func (i uintParser) Parse(t Token, value any) (any, httperror.HttpError) {
	val, ok := value.(string)
	if !ok {
...
func (i uint8Parser) Parse(t Token, value any) (any, httperror.HttpError) {
	val, ok := value.(string)
	if !ok {
		return nil, ErrInvalidInputValueString
	}
...
func (i uint16Parser) Parse(t Token, value any) (any, httperror.HttpError) {
	val, ok := value.(string)
	if !ok {
		return nil, ErrInvalidInputValueString
	}
...
func (i uint32Parser) Parse(t Token, value any) (any, httperror.HttpError) {
	val, ok := value.(string)
	if !ok {
		return nil, ErrInvalidInputValueString
	}
...
func (i uint64Parser) Parse(t Token, value any) (any, httperror.HttpError) {
	val, ok := value.(string)
	if !ok {
		return nil, ErrInvalidInputValueString
	}
...
func genericUintParser[T uint8 | uint16 | uint32 | uint64](val string, bitsize int, t Token) (T, httperror.HttpError) {
	var result T
