...
func (i intParser) Parse(t Token, value any) (any, httperror.HttpError) {
	val, ok := value.(string)
	if !ok {
...
func (i int8Parser) Parse(t Token, value any) (any, httperror.HttpError) {
	val, ok := value.(string)
	if !ok {
		return nil, ErrInvalidInputValueString
	}
...
func (i int16Parser) Parse(t Token, value any) (any, httperror.HttpError) {
	val, ok := value.(string)
	if !ok {
		return nil, ErrInvalidInputValueString
	}
...
func (i int32Parser) Parse(t Token, value any) (any, httperror.HttpError) {
	val, ok := value.(string)
	if !ok {
		return nil, ErrInvalidInputValueString
	}
...
func (i int64Parser) Parse(t Token, value any) (any, httperror.HttpError) {
	val, ok := value.(string)
	if !ok {
		return nil, ErrInvalidInputValueString
	}
...
func genericIntParser[T int8 | int16 | int32 | int64](val string, bitsize int, t Token) (T, httperror.HttpError) {
	var result T
